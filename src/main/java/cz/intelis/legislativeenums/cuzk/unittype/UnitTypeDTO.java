...
/**
 * DTO for UnitType entity (Typ jednotky).
 *
...
@NoArgsConstructor
@AllArgsConstructor
@JacksonXmlRootElement(localName = "unitType")
public class UnitTypeDTO {
    ...
    public static UnitTypeDTO fromEntity(UnitType entity) {
        ...
        dto.setCivilCode(entity.getCivilCode());
