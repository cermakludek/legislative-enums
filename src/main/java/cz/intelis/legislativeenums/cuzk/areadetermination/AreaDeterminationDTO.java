...
/**
 * DTO for AreaDetermination entity (Způsob určení výměry).
 *
...
@NoArgsConstructor
@AllArgsConstructor
@JacksonXmlRootElement(localName = "areaDetermination")
public class AreaDeterminationDTO {
    ...
    public static AreaDeterminationDTO fromEntity(AreaDetermination entity) {
        if (entity == null) return null;
        AreaDeterminationDTO dto = new AreaDeterminationDTO();
