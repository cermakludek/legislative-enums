...
/**
 * DTO for BuildingRightPurpose entity (Účel práva stavby).
 *
...
@NoArgsConstructor
@AllArgsConstructor
@JacksonXmlRootElement(localName = "buildingRightPurpose")
public class BuildingRightPurposeDTO {
    ...
    public static BuildingRightPurposeDTO fromEntity(BuildingRightPurpose entity) {
        if (entity == null) return null;
        BuildingRightPurposeDTO dto = new BuildingRightPurposeDTO();
