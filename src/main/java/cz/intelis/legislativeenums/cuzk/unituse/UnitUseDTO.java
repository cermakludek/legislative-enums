...
/**
 * DTO for UnitUse entity (Způsob využití jednotky).
 *
...
@NoArgsConstructor
@AllArgsConstructor
@JacksonXmlRootElement(localName = "unitUse")
public class UnitUseDTO {
    ...
    public static UnitUseDTO fromEntity(UnitUse entity) {
        if (entity == null) return null;
        UnitUseDTO dto = new UnitUseDTO();
