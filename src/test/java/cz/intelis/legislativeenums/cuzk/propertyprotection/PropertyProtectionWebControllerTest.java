...
@DisplayName("PropertyProtectionWebController Unit Tests")
class PropertyProtectionWebControllerTest {
    ...
    @InjectMocks
    private PropertyProtectionWebController controller;
    ...
    void setUp() {
        ...
        testDTO.setId(1L);
        testDTO.setCode("PP01");
        testDTO.setNameCs("Testovací ochrana nemovitosti");
        testDTO.setNameEn("Test property protection");
        testDTO.setDescriptionCs("Popis v češtině");
        testDTO.setDescriptionEn("Description in English");
        testDTO.setProtectionTypeCode("TYPE01");
        testDTO.setAppliesToLand(true);
        testDTO.setAppliesToBuilding(false);
        testDTO.setAppliesToUnit(true);
        testDTO.setAppliesToBuildingRight(false);
    ...
    void testList() {
        // Arrange
        List<PropertyProtectionDTO> items = Arrays.asList(testDTO);
        ...
        // Assert
        assertThat(viewName).isEqualTo("cuzk/property-protections/list");
    ...
    void testCreateForm() {
        ...
        // Assert
        assertThat(viewName).isEqualTo("cuzk/property-protections/form");
        verify(model).addAttribute(eq("item"), any(PropertyProtectionDTO.class));
    }
    ...
    void testCreateSuccess() {
        ...
        // Assert
        assertThat(viewName).isEqualTo("redirect:/web/cuzk/property-protections");
    ...
    void testCreateException() {
        ...
        // Assert
        assertThat(viewName).isEqualTo("redirect:/web/cuzk/property-protections/create");
        verify(service).create(testDTO);
    ...
    void testUpdateException() {
        ...
        // Assert
        assertThat(viewName).isEqualTo("redirect:/web/cuzk/property-protections/" + id + "/edit");
        verify(service).update(id, testDTO);
