...
@DisplayName("UnitUseWebController Unit Tests")
class UnitUseWebControllerTest {
    ...
    @InjectMocks
    private UnitUseWebController controller;
    ...
    void setUp() {
        ...
        testDTO.setId(1L);
        testDTO.setCode("UU01");
        testDTO.setNameCs("Testovací způsob využití");
        testDTO.setNameEn("Test unit use");
        testDTO.setDescriptionCs("Popis v češtině");
        testDTO.setDescriptionEn("Description in English");
        testDTO.setAbbreviation("TUU");
    ...
    void testList() {
        // Arrange
        List<UnitUseDTO> items = Arrays.asList(testDTO);
        ...
        // Assert
        assertThat(viewName).isEqualTo("cuzk/unit-uses/list");
    ...
    void testCreateForm() {
        ...
        // Assert
        assertThat(viewName).isEqualTo("cuzk/unit-uses/form");
        verify(model).addAttribute(eq("item"), any(UnitUseDTO.class));
    }
    ...
    void testCreateSuccess() {
        ...
        // Assert
        assertThat(viewName).isEqualTo("redirect:/web/cuzk/unit-uses");
    ...
    void testCreateException() {
        ...
        // Assert
        assertThat(viewName).isEqualTo("redirect:/web/cuzk/unit-uses/create");
        verify(service).create(testDTO);
    ...
    void testUpdateException() {
        ...
        // Assert
        assertThat(viewName).isEqualTo("redirect:/web/cuzk/unit-uses/" + id + "/edit");
        verify(service).update(id, testDTO);
