...
@DisplayName("SimplifiedParcelSourceWebController Unit Tests")
class SimplifiedParcelSourceWebControllerTest {
    ...
    @InjectMocks
    private SimplifiedParcelSourceWebController controller;
    ...
    void setUp() {
        ...
        testDTO.setId(1L);
        testDTO.setCode("SPS01");
        testDTO.setNameCs("Testovací zdroj parcely");
        testDTO.setNameEn("Test parcel source");
        testDTO.setDescriptionCs("Popis v češtině");
        testDTO.setDescriptionEn("Description in English");
        testDTO.setAbbreviation("TSP");
    ...
    void testList() {
        // Arrange
        List<SimplifiedParcelSourceDTO> items = Arrays.asList(testDTO);
        ...
        // Assert
        assertThat(viewName).isEqualTo("cuzk/simplified-parcel-sources/list");
    ...
    void testCreateForm() {
        ...
        // Assert
        assertThat(viewName).isEqualTo("cuzk/simplified-parcel-sources/form");
        verify(model).addAttribute(eq("item"), any(SimplifiedParcelSourceDTO.class));
    }
    ...
    void testCreateSuccess() {
        ...
        // Assert
        assertThat(viewName).isEqualTo("redirect:/web/cuzk/simplified-parcel-sources");
    ...
    void testCreateException() {
        ...
        // Assert
        assertThat(viewName).isEqualTo("redirect:/web/cuzk/simplified-parcel-sources/create");
        verify(service).create(testDTO);
    ...
    void testUpdateException() {
        ...
        // Assert
        assertThat(viewName).isEqualTo("redirect:/web/cuzk/simplified-parcel-sources/" + id + "/edit");
        verify(service).update(id, testDTO);
